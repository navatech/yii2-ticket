<?php
/** @var \navatech\ticket\models\TicketHead $ticketHead */

use yii\helpers\Html;
use yii\web\JsExpression;

/** @var \navatech\ticket\models\TicketBody $ticketBody */
?>
	...
	<div class="container-fluid row">
		<div class="col-md-12">
			...
			<div class="well">
				...
				<?= $form->field($ticketHead, 'department')->dropDownList($departments)->label('Сообщение')->error() ?>
