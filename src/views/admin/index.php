<?php
/** @var \navatech\ticket\models\TicketHead $dataProvider */
?>
						...
						[
							...
							'value'     => function($model) {
								switch ($model->body['client']) {
									case 0 :
										if ($model->status == \navatech\ticket\models\TicketHead::CLOSED) {
						...
						[
							...
							'buttons'       => [
								'update' => function($url, $model) {
									return \yii\helpers\Html::a('Ответить', \yii\helpers\Url::toRoute([
										'admin/answer',
										'id' => $model['id'],
									]), ['class' => 'btn-xs btn-info']);
								},
								'delete' => function($url, $model) {
									return \yii\helpers\Html::a('Удалить', \yii\helpers\Url::to([
										'admin/delete',
										'id' => $model['id'],
									]), [
								...
								'closed' => function($url, $model) {
									return \yii\helpers\Html::a('Закрыть', \yii\helpers\Url::to([
										'admin/closed',
										'id' => $model['id'],
									]), [
