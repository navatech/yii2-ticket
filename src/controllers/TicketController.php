...
use navatech\ticket\models\UploadForm;
...
class TicketController extends Controller {
	 ...
	 * К нам пришел пост делаем загрузку в модель и проходим валидацию, если все хорошо делаем выборку шапки, меняем ей
	 * статус и сохраняем Записываем id тикета новому ответу чтоб не потерялся и сохроняем новый ответ
	 *
	 * @param $id
	 *
	 * @return string
