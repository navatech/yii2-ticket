...
class TicketBody extends \yii\db\ActiveRecord {
	...
	public function beforeSave($insert) {
		...
		if ($this->module->mailSend !== false && $ticketHead->status != TicketHead::CLOSED) {
			...
			(new Mailer())->sendMailDataTicket($ticketHead->topic, $ticketHead->status, $ticketHead->id, $this->text)->setDataFrom($this->client == null ? Yii::$app->params['adminEmail'] : $userModel::findOne($ticketHead->user_id)->email, $this->module->subjectAnswer)->senda('mail');
//			$mailer->compose()
		}
